...
class ichiV1(IStrategy):
    ...
    buy_min_fan_magnitude_gain = DecimalParameter(1.001, 1.010, decimals=4, default=buy_params['buy_min_fan_magnitude_gain'], space='buy')

    sell_trend_indicator = CategoricalParameter(
        ['trend_close_5m', 'trend_close_15m', 'trend_close_30m', 'trend_close_1h', 'trend_close_2h',
         'trend_close_4h', 'trend_close_6h', 'trend_close_8h'],
        default=sell_params['sell_trend_indicator'], space='sell')
